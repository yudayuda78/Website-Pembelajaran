...
<html lang="en">
  ...
  <body>
    <div id="wrapper">
        ...
        <h1> Cara Mencari Besarnya Untung</h1>
        <br>
        <h1 class="rumusmath">Besarnya Untung = Presentase Untung X Harga Beli</h1>
        <br>
        ...
        <h1>Contoh</h1>
        <br>
        <h3>Seorang fotografer membeli sebuah kamera dengan harga Rp 4.500.000 kemudian dijual lagi dengan persentase untung sebesar 15%. Berapa besar keuntungan yang didapat fotografer tersebut?</h3>
        <br>
        <img src="../image/kamera.png" alt="barang" class="gambartengah">
        <br>
        <h1>Penyelesaian Soal</h1>
        <br>
        <h3>Diketahui :</h3>
        <h3>Harga beli = Rp 4.500.000</h3>
        <h3>Untung = 15%</h3>
        <br>
        <h3>Untung = Presentase Untung x Harga Beli</h3>
        <br>
        <h3>Untung = 15% x Rp 4.500.000</h3>
        <br>
        <h3>Untung = \( \frac{15}{100}\) x Rp 4.500.000,00</h3>
        <br>
        <h3>Untung = Rp 675.000,00</h3>
        <br>
        <h3>Jadi besar keuntungan yang didapat fotografer tersebut adalah Rp 675.000</h3>
        ...
        <div class="buttonprev">
            <a href="laba4.php"><h1>Kembali</h1></a>
        </div>
        <div class="buttonnext">
