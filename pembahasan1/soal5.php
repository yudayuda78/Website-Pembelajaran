...
<html lang="en">
  ...
  <body>
    <div id="wrapper">
        ...
        <h3>Harga sebuah handphone setelah mendapatkan diskon 50% adalah Rp 1.700.000. Harga awal Handphone tersebut adalah…</h3>
        <br>
        <h1>Penyelesaian Soal</h1>
        <br>
        <h3>Diketahui :</h3>
        <h3>Harga akhir handphone 1.700.000</h3>
        <h3>Diskon 30%</h3>
        <br>
        <h1>Harga awal = Harga akhir - (100%- presentase)</h1>
        <h3>Harga awal = 1.700.000 : 50%</h3>
        <h3>Harga awal = 1.700.000 : 50/100</h3>
        <h3>Harga awal = 1.700.000 x 100/50</h3>
        <h3>Harga awal = 3.400.000</h3>


        <div class="wrapperbutton"></div>
        <div class="buttonprev">
            <a href="soal4.php"><h1>Kembali</h1></a>
        </div>
        <div class="buttonnext">
            <a href="soal6.php"><h1>Lanjut</h1></a>
        </div>
