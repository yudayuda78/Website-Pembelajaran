...
<html lang="en">
  ...
  <body>
    <div id="wrapper">
        ...
        <h3>3. Joni membeli roti seharga Rp 50.000. Roti tersebut mendapatkan diskon 4%. Berapa harga roti setelah diskon</h3>
        <br>
        <h1>Penyelesaian Soal</h1>
        <br>
        <h3>Diketahui :</h3>
        <h3>Harga roti Rp 50.000</h3>
        <h3>Diskon 4%</h3>
        <br>
        <h1>Diskon = Harga Awal x Persentase Diskon</h1>
        <h3>50.000 x 4/100 = 2.000</h3>
        <h3>Harga yang harus dibayarkan 50.000-20.000</h3>
        <h3>Harga yang harus dibayarkan 48.000</h3>


        <div class="wrapperbutton"></div>
        <div class="buttonprev">
            <a href="soal2.php"><h1>Kembali</h1></a>
        </div>
        <div class="buttonnext">
            <a href="soal4.php"><h1>Lanjut</h1></a>
        </div>
