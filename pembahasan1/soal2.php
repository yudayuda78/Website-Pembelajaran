...
<html lang="en">
  ...
  <body>
    <div id="wrapper">
        ...
        <h3>Penjual sepeda menjual suatu sepeda seharga Rp 1.000.000. Sepeda tersebut mendapatkan diskon sebesar 20%. Harga yang harus dibayarkan untuk sepeda tersebut adalah</h3>
        <br>
        <h1>Penyelesaian Soal</h1>
        <br>
        <h3>Diketahui :</h3>
        <h3>Harga Sepeda	: 100.000</h3>
        <h3>Diskon		: 20%</h3>
        <br>
        <h1>Diskon = Harga Awal x Persentase Diskon</h1>
        <h3>100.000 x 20/100 = 20.000</h3>
        <h3>Harga yang harus dibayarkan 100.000-80.000</h3>
        <h3>Harga yang harus dibayarkan 20.000</h3>


        <div class="wrapperbutton"></div>
        <div class="buttonprev">
            <a href="soal1.php"><h1>Kembali</h1></a>
        </div>
        <div class="buttonnext">
            <a href="soal3.php"><h1>Lanjut</h1></a>
        </div>
